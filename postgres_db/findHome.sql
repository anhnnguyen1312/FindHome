...
-- Tạo trigger function để cập nhật createAt
-- CREATE OR REPLACE FUNCTION update_createAt()
-- RETURNS TRIGGER AS $$
-- BEGIN
--   NEW."createAt" = CURRENT_TIMESTAMP;
--   RETURN NEW;
-- END;
-- $$ LANGUAGE plpgsql;

-- -- Tạo trigger để cập nhật "createAt" khi bản ghi được cập nhật
-- CREATE TRIGGER update_createAt_trigger
-- BEFORE UPDATE ON "adminNotifications"
-- FOR EACH ROW
-- EXECUTE FUNCTION update_createAt();
-- ----------------------------
-- Records of adminNotifications
-- ----------------------------
INSERT INTO "adminNotifications" ("adminId", "userId", "postId", "message", "isRead", "createAt")
VALUES (70, 71, 39, 'Admin, Bài đăng CHO THUÊ NHÀ Ở CẨM LỆ vừa được duyệt', FALSE, '2024-07-01 14:03:46');

--INSERT INTO "adminNotifications" ("adminId", "userId", "postId", "message", "isRead")
--VALUES (70, 71, 39, 'Admin, Bài đăng CHO THUÊ NHÀ Ở CẨM LỆ vừa được duyệt', FALSE);

--INSERT INTO "adminNotifications" VALUES (70, 71, 39, 'Admin, Bài đăng CHO THUÊ NHÀ Ở CẨM LỆ vừa được duyệt', 0, '2024-07-01 14:03:46');
...
) ENGINE = InnoDB SERIAL  = 78 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "statusPost"  (
  ...
  "check" int NOT NULL,
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 84 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "userAction"  (
  ...
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 258 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "userLikes"  (
  ...
  "postId" int NOT NULL,
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 80 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "userNotifications"  (
  ...
  "isRead" smallint(1) NULL DEFAULT 0,
  "createAt" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 31 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "userToken"  (
  ...
  "create_at" TIMESTAMPNOT NULL,
  "expires_at" TIMESTAMPNOT NULL,
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE "users"  (
  ...
  PRIMARY KEY ("id") USING BTREE
) ENGINE = InnoDB SERIAL  = 97 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;
